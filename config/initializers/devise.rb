...
Devise.setup do |config|
   config.api.configure do |api|
    ...
    api.sign_up.extra_fields = [:first_name, :last_name, :category, :batch_name, :year, :username, :profile_picture_url]
  ...
  # config.secret_key = '1fc6f2a0f5639c7edaaa7e374d639760460c4ec328af62ad4359d57befa949aed802a94130000c04c3c821d740ade837d7439392a2232d281fb41c94cb9237e0'
  ...
  # config.pepper = 'e6070abedb2ff16b527d6478510c1e996384d0af05d2669b8d03c0cfe6d3f70b02184319336ca698f26c786cbc96517b1db492063df467f55cfbe718dfc8a686'
